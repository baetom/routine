...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _showNotificationWithNoSound() async {
    ...
    var platformChannelSpecifics = NotificationDetails(
        androidPlatformChannelSpecifics, iOSPlatformChannelSpecifics);
    await flutterLocalNotificationsPlugin.show(notificatoinId,
        '<b>silent</b> title', '<b>silent</b> body', platformChannelSpecifics);
  }
  ...
  Future<void> _showSoundUriNotification() async {
    ...
    var platformChannelSpecifics = NotificationDetails(
        androidPlatformChannelSpecifics, iOSPlatformChannelSpecifics);
    await flutterLocalNotificationsPlugin.show(notificatoinId,
        'uri sound title', 'uri sound body', platformChannelSpecifics);
  }
